...
<!-- ![创建知识库](/img/ragflow/quickstart-create-kb.webp){loading="lazy"} -->
...
<!-- ![上传文档](/img/ragflow/quickstart-upload-doc.webp){loading="lazy"} -->
...
<!-- ![配置分块策略](/img/ragflow/quickstart-chunking.webp){loading="lazy"} -->
...
<!-- ![关联 LLM](/img/ragflow/quickstart-llm-config.webp){loading="lazy"} -->
...
<!-- ![发起对话](/img/ragflow/quickstart-chat.webp){loading="lazy"} -->
