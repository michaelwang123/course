...
// 移动端模态框（<768px）：事件详情、关闭按钮、编辑/删除操作
...
export function EventDetailModal({
  ...
  // Focus modal when opened and trap focus
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className={[
          'relative w-full max-h-[90vh] bg-white overflow-y-auto',
          'rounded-t-2xl sm:rounded-2xl sm:max-w-md sm:mx-4',
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100 flex gap-3 sticky bottom-0 bg-white">
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm font-medium min-h-[44px]"
          >
            编辑
          </button>
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-red-50 text-red-600 border border-red-200 rounded-lg hover:bg-red-100 transition-colors text-sm font-medium min-h-[44px]"
          >
            删除
          </button>
        </div>
